...
import RelationshipGraph, { Relationship } from '../Insights/RelationshipGraph';
import {
    Accordion,
    AccordionSummary,
    AccordionDetails,
            ...
            >
                ...
                <Grid size={3} sx={{ padding: "10px 0px 10px 5px" }}>
                    ...
                    <Box sx={{
                        ...
                        <Accordion
                            defaultExpanded={hasData(entry.entrySource.labels)}
                        ...
                        >
                            ...
                            <AccordionDetails sx={{ padding: "15px 10px 15px 10px" }}>
                                {Object.keys(entry.entrySource.labels).length > 0 ? (
                                    <Box sx={{
                                        display: "grid",
