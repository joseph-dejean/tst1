export type ItemType = 'dataProducts' | 'category' | 'term';
export type RelationType = 'synonym' | 'related';

export interface DataProductsRelation {
  id: string; 
  type: RelationType;
  displayName: string;
  description?: string;
...
export interface DataProductsItem {
  id: string;
  type: ItemType;
  displayName: string;
  description?: string;
  ...
  linkedAssets?: any[];
  // Structure
  children?: DataProductsItem[];
  relations?: DataProductsRelation[];
}
...
export const MOCK_GLOSSARIES: DataProductsItem[] = [
  // ... (Entries 1-9 remain unchanged) ...
  // =========================================================
  // GLOSSARY 1: CUSTOMER
  // =========================================================
  {
    id: 'dataProducts-customer',
    type: 'dataProducts',
  ...
  // =========================================================
  {
    ...
    longDescription: `
      <p>This dataProducts serves as the definitive reference for all financial terminology used within the Global Finance Division. It encompasses standards for financial reporting, budgeting, forecasting, and internal auditing.</p>
      ...
      <p>Adherence to regulatory frameworks is paramount. This dataProducts aligns with the latest updates from the Financial Accounting Standards Board (FASB) and the International Accounting Standards Board (IASB).</p>
  ...
  // =========================================================
  {
    ...
    longDescription: `
      <p>This dataProducts provides a unified vocabulary for the Cloud Engineering and DevOps teams.</p>
  ...
  // =========================================================
  {
    ...
    children: [
        ...
        // Supporting terms for the links above to work internally within this dataProducts
        {
            id: 'term-scrum',
            type: 'term',
            displayName: 'Scrum Framework',
  ...
  // =========================================================
  {
    id: 'dataProducts-empty-test',
    type: 'dataProducts',
    displayName: 'Empty DataProducts Test',
    description: '',
    longDescription: '',
